...
func create_new_dialog_node_from_ydec(node_data : Dictionary):
	...
	for i in node_data.keys():
		if i == "position_offset.x" or i == "position_offset.y" or i == "filename" or i == "quest_availabilities" or i == "dialog_availabilities" or i == "faction_availabilities" or i == "scoreboard_availabilities" or i == "faction_changes" or i == "response_options" or i == "mail" or i == "image_dictionary" or i == "attribute_check" or i == "command":
			continue
