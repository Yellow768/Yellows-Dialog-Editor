...
Last README file update: Wed Feb 23 01:59:27 PST 2022
...
command.noppes
command.noppes.clone
command.noppes.clone.add
command.noppes.clone.add.npc
command.noppes.clone.add.npc.tab
command.noppes.clone.add.npc.tab.name
command.noppes.clone.grid
command.noppes.clone.grid.name
command.noppes.clone.grid.name.tab
command.noppes.clone.grid.name.tab.length
command.noppes.clone.grid.name.tab.length.width
command.noppes.clone.grid.name.tab.length.width.pos
command.noppes.clone.grid.name.tab.length.width.pos.display_name
command.noppes.clone.list
command.noppes.clone.list.tab
command.noppes.clone.remove
command.noppes.clone.remove.name
command.noppes.clone.remove.name.tab
command.noppes.clone.spawn
command.noppes.clone.spawn.name
command.noppes.clone.spawn.name.tab
command.noppes.clone.spawn.name.tab.pos
command.noppes.clone.spawn.name.tab.pos.display_name
command.noppes.config
command.noppes.config.chunkloaders
command.noppes.config.chunkloaders.number
command.noppes.config.debug
command.noppes.config.debug.boolean
command.noppes.config.font
command.noppes.config.font.font
command.noppes.config.font.font.size
command.noppes.config.freezenpcs
command.noppes.config.freezenpcs.boolean
command.noppes.config.icemelts
command.noppes.config.icemelts.boolean
command.noppes.config.leavesdecay
command.noppes.config.leavesdecay.boolean
command.noppes.config.scripting
command.noppes.config.scripting.boolean
command.noppes.config.vineinflateth
command.noppes.config.vineinflateth.boolean
command.noppes.dialog
command.noppes.dialog.read
command.noppes.dialog.read.players
command.noppes.dialog.read.players.dialog
command.noppes.dialog.reload
command.noppes.dialog.show
command.noppes.dialog.show.players
command.noppes.dialog.show.players.dialog
command.noppes.dialog.show.players.dialog.name
command.noppes.dialog.unread
command.noppes.dialog.unread.players
command.noppes.dialog.unread.players.dialog
command.noppes.faction
command.noppes.faction.players
command.noppes.faction.players.faction
command.noppes.faction.players.faction.add
command.noppes.faction.players.faction.add.points
command.noppes.faction.players.faction.drop
command.noppes.faction.players.faction.reset
command.noppes.faction.players.faction.set
command.noppes.faction.players.faction.set.points
command.noppes.mark
command.noppes.mark.clear
command.noppes.mark.entities
command.noppes.mark.entities.type
command.noppes.mark.entities.type.color
command.noppes.npc
command.noppes.npc.npc
command.noppes.npc.npc.create
command.noppes.npc.npc.delete
command.noppes.npc.npc.delete.name
command.noppes.npc.npc.home
command.noppes.npc.npc.home.pos
command.noppes.npc.npc.owner
command.noppes.npc.npc.owner.player
command.noppes.npc.npc.reset
command.noppes.npc.npc.visible
command.noppes.npc.npc.visible.visibility
command.noppes.quest
command.noppes.quest.finish
command.noppes.quest.finish.players
command.noppes.quest.finish.players.quest
command.noppes.quest.objective
command.noppes.quest.objective.players
command.noppes.quest.objective.players.quest
command.noppes.quest.objective.players.quest.objective
command.noppes.quest.objective.players.quest.objective.value
command.noppes.quest.reload
command.noppes.quest.remove
command.noppes.quest.remove.players
command.noppes.quest.remove.players.quest
command.noppes.quest.start
command.noppes.quest.start.players
command.noppes.quest.start.players.quest
command.noppes.quest.stop
command.noppes.quest.stop.players
command.noppes.quest.stop.players.quest
command.noppes.scene
command.noppes.scene.pause
command.noppes.scene.pause.name
command.noppes.scene.reset
command.noppes.scene.reset.name
command.noppes.scene.start
command.noppes.scene.start.name
command.noppes.scene.time
command.noppes.scene.time.time
command.noppes.scene.time.time.name
command.noppes.schema
command.noppes.schema.build
command.noppes.schema.build.name
command.noppes.schema.build.name.pos
command.noppes.schema.build.name.pos.rotation
command.noppes.schema.info
command.noppes.schema.list
command.noppes.schema.stop
command.noppes.script
command.noppes.script.reload
command.noppes.script.run
command.noppes.script.run.args
command.noppes.slay
command.noppes.slay.type
command.noppes.slay.type.range
command.op
command.op.targets
command.pardon
command.pardon-ip
